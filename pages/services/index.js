  ...
  return <div className="h-full bg-primary/30 py-36 flex items-center">
    ...
    <div className="container mx-auto">
      <div className="flex flex-col xl:fex-row gap-x-8">
        ...
        className="h2 xl:mt-8">Que encontrarás? <span className="text-accent"></span></motion.h2>
        <motion.p variants={fadeIn("up",0.4)} initial="hidden" animate="show" exit="hidden" 
        className="mb-4 max-w-[400px] mx-auto lg:mx-0">Echa un vistazo más de cerca a los lenguajes que vas a encontrar en Data-Xplore</motion.p>
        </div>
